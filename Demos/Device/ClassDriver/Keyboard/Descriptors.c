 ...
 *  process begins.
 */
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor ATTR_ALIGNED(2) =
{
 ...
 */
const USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor ATTR_ALIGNED(2) =
{
	.Config =
		{
